...
activities = {
    ...
    "Tennis Club": {
        "description": "Master tennis skills and compete in friendly matches",
    ...
    "Art Studio": {
        ...
        "max_participants": 18,
        "participants": ["sophie@mergington.edu", "benjamin@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Play in our school orchestra and perform in concerts",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 4:00 PM - 5:15 PM",
        "max_participants": 16,
